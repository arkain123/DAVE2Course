...
namespace Lab7
{
    internal class StringListSolver : Solver, ISave
    {
        private List<object> results;

        public List<object> Result { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        public StringListSolver(double lB, double uB, double h, double iny0, IEquation ineq)
        ...
        {
            Result.Add(item.x.ToString() + "~" + item.y.ToString());
        }
    }
}
